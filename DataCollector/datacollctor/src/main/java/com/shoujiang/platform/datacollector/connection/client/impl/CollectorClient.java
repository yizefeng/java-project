package com.shoujiang.platform.datacollector.connection.client.impl;

import com.shoujiang.platfor.base.util.CommonUtil;
import com.shoujiang.platform.datacollector.connection.client.IClient;
import com.shoujiang.platform.datacollector.connection.client.handler.ClientHandler;
 ...
 */
public class CollectorClient implements IClient {

    private Logger logger = LoggerFactory.getLogger(CollectorClient.class);
    //客服端启动类
